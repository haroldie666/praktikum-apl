...
void createAdmin(produk produkList[], int *jumlahProduk, int maxProduk) {
    ...
    produkBaru->id = maxId + 1; // Menggunakan arrow operator untuk mengakses nilai pada struct melalui pointer
...
void deleteAdmin(produk produkList[], int *jumlahProduk) { // Menggunakan dereference operator sebagai parameter
    system("cls");
    ...
    do {
        ...
        switch (menuAdmin) {
            case 1: 
                ...
                break;
            case 2: 
                createAdmin(produkList, &jumlahProduk, maxProduk); // Menggunakan address of operator sebagai parameter
            break;
            case 3: 
...
int main() {
    ...
    do {
        ...
        switch (menuUtama) {
            ...
            case 2: 
                registerr(users, &jumlahUser, maxUser); // Menggunakan address of operator sebagai parameter
                cout << "\nTekan enter untuk melanjutkan...";
                cin.get();
                break;
            case 3: 
